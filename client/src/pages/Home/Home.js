  ...
  return (
    <div className="main">
      ...
      <div className="home-bottomContainer">
        <p>
          Have you ever sat there looking at the Chikn and Roostrs in the marketplace, seen one that's not for sale and
          thought to yourself "Damn I want that Coq". Well, now is the time to do something about it. This website is
